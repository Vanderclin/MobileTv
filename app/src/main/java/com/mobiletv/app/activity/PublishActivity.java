...
import com.mobiletv.app.widget.Cover;
...
public class PublishActivity extends AppCompatActivity {
    ...
    private void initializeFindViews() {
        ...
        actionImage.setDimension(259, 385);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CODE_GALLERY_PERMISSION) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(PublishActivity.this, getString(R.string.gallery_permission_denied), Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void actionSaveDatabase() {
        ...
        if (imageUriCover != null && !TextUtils.isEmpty(title) && !TextUtils.isEmpty(description) && episodeCounter > 0) {
            ...
            Toast.makeText(PublishActivity.this, getString(R.string.fill_required_fields), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void uploadImage(SeriesDetails seriesDetails, String title, String description) {
        ...
        coverUploadTask.addOnSuccessListener(taskSnapshot -> coverImageRef.getDownloadUrl().addOnSuccessListener(cover -> saveSeriesDetails(seriesDetails, cover, title, description))).addOnFailureListener(e -> Toast.makeText(PublishActivity.this, getString(R.string.error_upload_cover_image), Toast.LENGTH_SHORT).show());
    }
    ...
    private void saveSeriesDetails(SeriesDetails seriesDetails, Uri cover, String title, String description) {
        ...
        if (position != null) {
            mData.child("series").child(position).setValue(seriesDetails).addOnSuccessListener(aVoid -> {
                ...
                Toast.makeText(PublishActivity.this, getString(R.string.added_successfully), Toast.LENGTH_SHORT).show();
                finish();
