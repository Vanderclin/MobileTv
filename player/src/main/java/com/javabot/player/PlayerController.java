...
public class PlayerController extends FrameLayout {
    ...
    public PlayerController(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        @SuppressLint("CustomViewStyleable") TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.PlayerController);
        mScalable = a.getBoolean(R.styleable.PlayerController_player_scalable, false);
        a.recycle();
        init(context);
    }
    ...
    public void reset() {
        ...
        advancedPlayer.setImageResource(R.drawable.player_play);
        setVisibility(VISIBLE);
        hideLoading();
    }
    ...
    private void updatePausePlay() {
        int playIcon = mPlayer != null && mPlayer.isPlaying() ? R.drawable.player_pause : R.drawable.player_play;
        advancedPlayer.setImageResource(playIcon);
    }

    void updateScaleButton() {
        int scaleIcon = mIsFullScreen ? R.drawable.player_fullscreen_close : R.drawable.player_fullscreen_open;
