...
public class PlayerWhiteNoise extends View {
    ...
    public PlayerWhiteNoise(Context context) {
        super(context);
        init();
    }

    public PlayerWhiteNoise(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PlayerWhiteNoise(Context context, AttributeSet attrs, int defStyleAttr) {
